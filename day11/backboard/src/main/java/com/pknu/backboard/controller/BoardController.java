...
public class BoardController {
  ...
  @PreAuthorize("isAuthenticated()")
  @PostMapping("/modify/{bno}") //수정요청
  public String postModify(BoardForm boardForm,BindingResult bindingResult,@PathVariable("bno")Long bno,Principal principal) {
    if(bindingResult.hasErrors()){
      return "board/board_create";
    }
    Board board = this.boardService.getBoardOne(bno);
